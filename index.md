...
hero:
  ...
  actions:
    - theme: brand
      text: 🎯 1分钟快速开始
      link: /intro
      description: 立即体验极速搭建项目模板
    - theme: alt
      text: 📚 查看文档
      link: /core/脚手架核心.md
      description: 详细了解脚手架功能和使用方法
    - theme: alt
      text: ⭐ GitHub 仓库
      link: https://github.com/whyfail
      description: 给我们一个 star 支持
...
features:
  ...
  - title: 🎯 四套模板支持
    icon: 🎯
    details: 提供 React、Vue 3 的 SPA 与 SSR 模板，可按需选择 Vite、Next.js 或 Nuxt，快速搭建项目。
  - title: 🔄 持续更新
    icon: 🔄
...
📚 [查看文档](/core/脚手架核心.md) | ⭐ [GitHub 仓库](https://github.com/whyfail/cwa-stack) 
