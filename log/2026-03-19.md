---
title: "React Grab 使用文档"
description: "React Grab 是一个专为前端开发的开发者工具，允许你直接从网站页面上选择 UI 元素，快速获取其代码上下文信息（包括文件名、组件名和 HTML 源码），并将其复制到剪贴板。 提升 AI 编码效率 ：为 Trae、Curso..."
keywords: ["React","TypeScript","React Grab 使用文档","2026-03-19"]
category: "AI / DEVEX"
