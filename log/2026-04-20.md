---
title: "Vite 8 + React 19 依赖库全面升级"
description: "本次更新对 vite react init （React 模板）和 vite vue3 init （Vue3 模板）两个项目模板的所有依赖库进行了全面检查和升级，确保使用最新的稳定版本，拥抱前端生态的最新特性和性能优化。"
keywords: ["Vite","Rolldown","Oxc","React","Vue","Pinia","TypeScript","ESLint","UnoCSS","Ant Design","Vite 8 + React 19 依赖库全面升级","2026-04-20"]
