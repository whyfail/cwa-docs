---
title: "使用 simple-git-hooks"
description: "2024 年 12 月 29 日 simple-git-hooks 是一个轻量级的 Git 钩子管理工具，它可以帮助你管理 Git 仓库中的多个 Git 钩子。 一般的项目中都是可以平替 husky 零依赖 极少的配置（仅为 pa..."
keywords: ["使用 simple-git-hooks","2024-12-29"]
category: "TOOLING"
