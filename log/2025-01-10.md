---
title: "使用 zustand 作为 React 状态管理库"
description: "2025 年 1 月 10 日 zustand 是一个 React 状态管理库，它可以帮助我们管理 React 组件的状态，并且它是无侵入的，不会影响组件的渲染。 zustand 是一个轻量级的状态管理库，它仅仅只有 1KB 大小..."
keywords: ["React","Zustand","使用 zustand 作为 React 状态管理库","2025-01-10"]
