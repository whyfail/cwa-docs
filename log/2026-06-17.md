---
title: "React / Vue 企业级架构重构"
description: "React 模板完成一次面向 AI 协作的企业级重构：从旧的 demo 模板整理为 app / features / shared 分层结构。 Vue3 模板同步完成企业级架构模板改造：目录、UI、样式、图标、文档页、AGENTS..."
keywords: ["Vite","React","Vue","UnoCSS","React / Vue 企业级架构重构","2026-06-17"]
