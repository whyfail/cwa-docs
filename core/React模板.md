...
5. **类型与代码规范** - 遵循TypeScript和ESLint规则，提交前自动检查
...
React 模板已从 JS/JSX 迁移到 TS/TSX，核心文件包括 `App.tsx`、`main.tsx`、`RouterAuth.tsx`、`storeUser.ts` 等。提交前建议执行：
